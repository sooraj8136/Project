                    ...
                    <div>
                        <ul className="nav justify-content-center">
                            <li className="nav-item ">
                                <Nav.Link href="/ladies" className={darkMode ? "text-black" : "text-white nav-link"}>Ladies</Nav.Link>
                            </li>
                            <li className="nav-item">
                                <Nav.Link href="/men" className={darkMode ? "text-black" : "text-white nav-link"}>Men</Nav.Link>
                            </li>
                            <li className="nav-item">
                                <Nav.Link href="/" className={darkMode ? "text-black" : "text-white nav-link"}>Kids</Nav.Link>
                            </li>
                            <li className="nav-item">
