            ...
            <Container>
                <section>
                    <div
                        ...
                        >
                            <img
                                src="https://www2.hm.com/content/dam/global_campaigns/season_07/baby/4107-parenthood/editorial-hub/4107g-sustainability/4107G-edi-16x9-CPD-2-sustainability.jpg"
                                className="img-fluid"
                                alt="Sample"
                                style={{
                                    width: "100%",
                                ...
                                <div style={{
                                    ...
                                    <ul className="preppy-btn" style={{ listStyleType: "none", padding: 0, margin: 0 }}>
                                        <li style={{ cursor: "pointer", color: "white" }}>
                                            <Nav.Link href="/Hello-kitty" >Shop now</Nav.Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
export default KidsLimitedEdition